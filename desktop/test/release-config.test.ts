...
test("Forge config exposes installers and portable archives for supported platforms", () => {
  ...
  assert.deepEqual(byName.get("@electron-forge/maker-zip")?.platforms, ["darwin", "win32"]);
});
