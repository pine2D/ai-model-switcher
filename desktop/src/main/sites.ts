...
export const SITES = Object.freeze([
  { key: "claude", host: "claude.ai", label: "Claude", url: "https://claude.ai/new", authHosts: ["accounts.google.com", "accounts.youtube.com", "appleid.apple.com"], image: true, intl: true },
  { key: "chatgpt", host: "chatgpt.com", label: "ChatGPT", url: "https://chatgpt.com/", authHosts: ["auth.openai.com", "auth0.openai.com", "accounts.google.com", "accounts.youtube.com", "appleid.apple.com", "login.microsoftonline.com"], image: true, intl: true },
  { key: "gemini", host: "gemini.google.com", label: "Gemini", url: "https://gemini.google.com/app", authHosts: ["accounts.google.com", "accounts.youtube.com"], image: false, intl: true },
