...
const MSG = {
  ...
  arc_loadFailed: { en: "Couldn't load the archive. Try again.", zh_CN: "归档加载失败，请重试。", zh_TW: "歸檔載入失敗，請重試。" },
  arc_saveFailed: { en: "Couldn't save the archive. Try again.", zh_CN: "归档保存失败，请重试。", zh_TW: "封存儲存失敗，請重試。" },
  arc_deleteFailed: { en: "Couldn't delete the archive. Try again.", zh_CN: "归档删除失败，请重试。", zh_TW: "封存刪除失敗，請重試。" },
  ...
  con_grpImage: { en: "Image-ready", zh_CN: "支持图片", zh_TW: "支援圖片" },
  con_grpNone: { en: "None", zh_CN: "清空", zh_TW: "清空" },
  con_grpIntl: { en: "International", zh_CN: "国外", zh_TW: "國外" },
  con_grpDomestic: { en: "Domestic", zh_CN: "国内", zh_TW: "國內" },
  ...
  con_errImageInvalid: { en: "Invalid image data — choose it again", zh_CN: "图片数据无效，请重新选择", zh_TW: "圖片資料無效，請重新選擇" },
  ...
  con_errAttachmentAction: { en: "Confirm image use on the site, then retry; text was not sent", zh_CN: "请先在站点页面确认图片使用条款后重试，未发送文字", zh_TW: "請先在站點頁面確認圖片使用條款後重試，未傳送文字" },
  ...
  con_collectDoneUnarchived: { en: "Summary copied, but the archive was not saved", zh_CN: "汇总已复制，但归档未保存", zh_TW: "彙總已複製，但封存未儲存" },
