...
const MSG = {
  ...
  con_histTitle: { en: "Question history (use ↑/↓ in the input)", zh_CN: "提问历史（可在输入框中按 ↑/↓ 切换）", zh_TW: "提問記錄（可在輸入框中按 ↑/↓ 切換）" },
  ...
  con_archiveTitle: { en: "View archived comparisons (questions and answers)", zh_CN: "查看归档对比（问题和各站回答）", zh_TW: "查看封存記錄（問題和各站回答）" },
  arc_title: { en: "Archive", zh_CN: "结果归档", zh_TW: "封存記錄" },
  arc_listAria: { en: "Archived comparisons", zh_CN: "归档条目", zh_TW: "封存記錄" },
  arc_empty: { en: "No archived comparisons yet.", zh_CN: "暂无归档对比。", zh_TW: "尚無封存記錄。" },
  ...
  arc_delConfirm: { en: "Delete this archive?", zh_CN: "删除这条归档？", zh_TW: "刪除這筆封存記錄？" },
  arc_more: { en: "Load more", zh_CN: "加载更多", zh_TW: "載入更多" },
  arc_loadFailed: { en: "Couldn't load the archive. Try again.", zh_CN: "归档加载失败，请重试。", zh_TW: "封存記錄載入失敗，請重試。" },
  arc_saveFailed: { en: "Couldn't save the archive. Try again.", zh_CN: "归档保存失败，请重试。", zh_TW: "封存記錄儲存失敗，請重試。" },
  arc_deleteFailed: { en: "Couldn't delete the archive. Try again.", zh_CN: "归档删除失败，请重试。", zh_TW: "封存記錄刪除失敗，請重試。" },
  arc_searchPh: { en: "Search saved results", zh_CN: "搜索已保存结果", zh_TW: "搜尋已儲存的結果" },
  arc_searchAria: { en: "Search saved results", zh_CN: "搜索已保存结果", zh_TW: "搜尋已儲存的結果" },
  arc_favorites: { en: "Favorites", zh_CN: "收藏", zh_TW: "收藏" },
  arc_tagFilter: { en: "Filter by tag", zh_CN: "按标签筛选", zh_TW: "依標籤篩選" },
  arc_allTags: { en: "All tags", zh_CN: "全部标签", zh_TW: "所有標籤" },
  arc_favorite: { en: "Favorite", zh_CN: "收藏", zh_TW: "收藏" },
  arc_tags: { en: "Tags (comma-separated)", zh_CN: "标签（用逗号分隔）", zh_TW: "標籤（以逗號分隔）" },
  arc_note: { en: "Private note (not exported)", zh_CN: "私人备注（不会导出）", zh_TW: "私人備註（不會匯出）" },
  ...
  arc_markBest: { en: "Best answer", zh_CN: "最佳回答", zh_TW: "最佳答案" },
  arc_updateFailed: { en: "Couldn't save your changes. Try again.", zh_CN: "更改保存失败，请重试。", zh_TW: "變更儲存失敗，請再試一次。" },
  ...
  con_moreArchive: { en: "Open archive", zh_CN: "打开归档", zh_TW: "開啟封存記錄" },
  con_moreCheckup: { en: "Check selected sites", zh_CN: "巡检所选站点", zh_TW: "巡檢所選網站" },
  con_moreNewSession: { en: "New session for selected sites", zh_CN: "为所选站点开启新会话", zh_TW: "為所選網站開啟新對話" },
  ...
  con_checkupTitle: { en: "Check adapters for selected sites (read-only)", zh_CN: "只读检查所选站点的适配器", zh_TW: "以唯讀方式檢查所選網站的適配器" },
  ...
  con_collectDoneUnarchived: { en: "Summary copied, but the archive was not saved", zh_CN: "汇总已复制，但归档未保存", zh_TW: "彙總已複製，但封存記錄未儲存" },
  ...
  pop_diag:        { en: "Diagnose current site",                       zh_CN: "诊断当前站点",                      zh_TW: "診斷目前網站" },
  ...
  diag_iframeLimited:{ en: "iframe limitation: Haiku only (Claude embed; use a standalone tab)", zh_CN: "iframe 受限：仅支持 Haiku（Claude 嵌入页，请改用独立标签页）", zh_TW: "iframe 受限：僅支援 Haiku（Claude 嵌入頁，請改用獨立分頁）" },
